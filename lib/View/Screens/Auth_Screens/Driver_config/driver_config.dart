...
import 'package:aminidriver/View/Screens/Auth_Screens/Driver_config/driver_logics.dart';
                            ...
                            Padding(
                              ...
                              child: SizedBox(
                                ...
                                child: DropdownButton(
                                  value: ref.watch(
                                    driverConfigDropDownProvider,
                                  ),
                                  onChanged: (val) {
                                    ref
                                        .watch(
                                          driverConfigDropDownProvider.notifier,
                                        )
                                        .update((state) => val);
                                  },
