...
//     try {
//       final driverResult = await driverController.submitDriverData();
//       final vehicleResult = await vehicleController.submitVehicleData(driverResult["driverId"], driverResult["email"]);

//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text("Driver and Vehicle Onboarding Successful")),
//       );
//     } catch (e) {
//       ScaffoldMessenger.of(context).showSnackBar(
...
//                             }).toList(),
//                             onChanged: (value) => setState(() => driverController.selectedIdType = value),
...
//                                     ? Icons.check_circle
//                                     : Icons.upload_file,
//                                 color: driverController.documents[entry.key] != null ? Colors.green : null,
//                               ),
...
//                             }).toList(),
//                             onChanged: (value) => setState(() => vehicleController.selectedCategory = value),
...
//                                     ? Icons.check_circle
//                                     : Icons.upload_file,
//                                 color: vehicleController.documents[entry.key] != null ? Colors.green : null,
//                               ),
